...
- **[Store animals and animals info]**
- **[Get information about animals, like how many and their average age.. etc]**
...
- Check [queries.sql](./queries.sql) for examples of queries that can be run on a newly created 
